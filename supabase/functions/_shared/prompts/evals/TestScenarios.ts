...
export class GoldenTestSets {
  ...
  private static createQuestioningAdversarialTests(): QuestioningTestScenario[] {
    return [
      {
        name: 'questioning_adversarial_category_confusion',
        description: 'Test handling when user seems confused about category',
        category: 'animals',
        questionsAsked: 3,
        conversationHistory: 'Q1: Is it alive?\nA1: No\nQ2: Is it electronic?\nA2: Yes\nQ3: Can you hold it?\nA3: Yes',
        alreadyAskedQuestions: ['Is it alive?', 'Is it electronic?', 'Can you hold it?'],
        input: {}
      },

      {
        name: 'questioning_adversarial_infinite_maybe',
        description: 'Test handling of user who answers "maybe" to everything',
        category: 'objects',
        questionsAsked: 8,
        conversationHistory: Array.from({length: 8}, (_, i) => 
          `Q${i+1}: Question ${i+1}?\nA${i+1}: Maybe`
        ).join('\n'),
        alreadyAskedQuestions: Array.from({length: 8}, (_, i) => `Question ${i+1}?`),
        input: {}
      }
    ]
  }
  ...
  private static createGuessingAdversarialTests(): GuessingTestScenario[] {
    return [
      {
        name: 'guessing_adversarial_null_answers',
        description: 'Test handling of null/empty answers',
        category: 'animals',
        questionsByNumber: { 1: 'Is it a mammal?', 2: 'Is it wild?' },
        answersByNumber: { 1: '', 2: null as any },
        allAskedQuestions: ['Is it a mammal?', 'Is it wild?'],
        currentQuestionNumber: 2,
        input: {}
      },

      {
        name: 'guessing_adversarial_nonsense_answers',
        description: 'Test handling of nonsensical answers',
        category: 'objects',
        questionsByNumber: {
          1: 'Is it electronic?',
          2: 'Can you hold it?',
        ...
        answersByNumber: {
          1: 'Purple elephant dancing',
          2: '42 is the answer',
          3: 'Question not applicable to this dimension'
        },
        allAskedQuestions: ['Is it electronic?', 'Can you hold it?', 'Is it useful?'],
        currentQuestionNumber: 3,
        input: {}
  ...
  private static createHintingAdversarialTests(): HintTestScenario[] {
    return [
      {
        name: 'hint_adversarial_impossible_item',
        description: 'Test hint generation for impossible/fictional items',
        secretItem: 'invisible_unicorn',
        category: 'animals',
        hintsUsed: 0,
        questionsAsked: 5,
        conversationHistory: [],
        ...
        establishedFacts: {
          confirmed_yes: [
            { question: 'Is it magical?', confidence: 1.0 },
            { question: 'Is it invisible?', confidence: 1.0 }
          ],
          confirmed_no: [
            { question: 'Does it exist?', confidence: 0.9 }
          ],
          uncertain: []
        },
        input: {}
      ...
      {
        name: 'hint_adversarial_over_disclosure',
        description: 'Test prevention of over-disclosure in early hints',
        secretItem: 'lion',
        category: 'animals',
        hintsUsed: 0,
        questionsAsked: 1,
